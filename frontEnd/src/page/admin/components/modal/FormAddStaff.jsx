                ...
                <div className="backdrop-blur-2xl p-4 rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.06)] w-full">
                    <div className="space-y-2">
                        ...
                        <button 
                            ...
                            className="px-10 py-3 bg-primary text-white font-bold rounded-lg shadow-lg shadow-primary/20 hover:bg-primary-container active:scale-95 transition-all" type="submit">
                            Lưu thông tin
                        </button>
                    </div>
                </div>
