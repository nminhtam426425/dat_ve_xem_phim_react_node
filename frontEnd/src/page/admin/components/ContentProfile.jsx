import { Calendar, Camera, IdCardLanyard, Mail, Phone, User, History, Lock, Edit } from "lucide-react"
import { branch, customeFetch, apiUserService, uploadCloudinary } from "../../config"
import { formatPhone } from "../../validate"
import { useLoading } from "../../../LoadingContext"

const ContentProfile = ({user, setDataItem, imgAvatar, setConfirm, setAvatar, setUserInfo, setShowFormChangePass}) => {
            ...
            <div className="bg-surface-container-lowest p-6 rounded-xl border border-outline-variant/20 shadow-sm sticky top-24">
                <div className="flex flex-col items-center mb-8">
                    <div className="relative group cursor-pointer mb-4">
                        ...
                        <label className="absolute bottom-0 right-0 bg-primary text-on-primary w-10 h-10 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform cursor-pointer" htmlFor="avatar-upload">
                            <input 
                                accept=".jpg, .jpeg, .png" 
                                className="hidden" 
                                id="poster-input" 
                ...
                <div className="space-y-2">
                    <div className="flex items-center gap-3 px-4 py-3 bg-primary-container text-on-primary-container font-bold rounded-lg transition-all duration-150">
                    ...
                    <div className="px-4 py-3 text-secondary hover:bg-secondary-container/50 rounded-lg transition-all duration-150">
                        <button 
                ...
                <div className="space-y-6" method="POST">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col gap-2">
                            <label className="text-label-bold text-on-surface-variant uppercase tracking-wider" htmlFor="fullname">Họ tên</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-label-bold text-on-surface-variant uppercase tracking-wider" htmlFor="dob">Ngày sinh</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-label-bold text-on-surface-variant uppercase tracking-wider" htmlFor="phone">Số điện thoại</label>
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-label-bold text-on-surface-variant uppercase tracking-wider" htmlFor="email">Email</label>
                    ...
                    <div className="pt-6 border-t border-outline-variant/10 flex flex-col sm:flex-row justify-end gap-4">
                        <button 
                            className="flex items-center gap-2 px-12 py-3 rounded-lg bg-primary-container text-on-primary font-bold shadow-lg hover:brightness-110 transition-all active:scale-95" 
